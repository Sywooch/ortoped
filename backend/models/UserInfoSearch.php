...
class UserInfoSearch extends UserInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['first_name', 'second_name', 'avatar', 'website', 'city', 'country', 'pr', 'socialUrl1', 'socialUrl2', 'socialUrl3', 'socialUrl4', 'socialUrl5', 'socialUrl6', 'partner', 'prDescr', 'contactPerson', 'contactEmail','phone'], 'safe'],
        ];
    }
