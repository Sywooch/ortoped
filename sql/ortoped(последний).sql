...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 15 2016 г., 10:20
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 COMMENT='чат для техников и мед директоров';
...
--
-- Структура таблицы `orto_clinic_doctor`
--
...
--
-- Дамп данных таблицы `orto_clinic_doctor`
--
...
--
-- Индексы таблицы `orto_alerts`
--
ALTER TABLE `orto_alerts`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_banners`
--
ALTER TABLE `orto_banners`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_chat`
--
...
--
-- Индексы таблицы `orto_clinics`
--
ALTER TABLE `orto_clinics`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_clinic_doctor`
--
ALTER TABLE `orto_clinic_doctor`
  ADD PRIMARY KEY (`doctor_id`,`clinic_id`);

--
-- Индексы таблицы `orto_comments`
--
ALTER TABLE `orto_comments`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_doctors`
--
ALTER TABLE `orto_doctors`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_formula`
--
ALTER TABLE `orto_formula`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_materials`
--
ALTER TABLE `orto_materials`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_objects`
--
ALTER TABLE `orto_objects`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_options`
--
ALTER TABLE `orto_options`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_orders`
--
ALTER TABLE `orto_orders`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_pacients`
--
ALTER TABLE `orto_pacients`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_plans`
--
ALTER TABLE `orto_plans`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `orto_user`
--
...
--
-- Индексы таблицы `orto_user_info`
--
...
--
-- AUTO_INCREMENT для таблицы `orto_alerts`
--
ALTER TABLE `orto_alerts`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `orto_banners`
--
ALTER TABLE `orto_banners`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `orto_chat`
--
ALTER TABLE `orto_chat`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=136;
--
-- AUTO_INCREMENT для таблицы `orto_clinics`
--
ALTER TABLE `orto_clinics`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `orto_comments`
--
ALTER TABLE `orto_comments`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `orto_formula`
--
ALTER TABLE `orto_formula`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `orto_options`
--
ALTER TABLE `orto_options`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `orto_orders`
--
ALTER TABLE `orto_orders`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT для таблицы `orto_plans`
--
ALTER TABLE `orto_plans`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `orto_user`
--
ALTER TABLE `orto_user`
